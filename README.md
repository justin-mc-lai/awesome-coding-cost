...
| 套餐 | 价格 | 模型 | TPS | 月度 Token(亿) | 每元 Token 数 | 每亿 Token 成本 | 额度倍率 | 备注 |
|------|------|------|:--:|:--:|:--:|:--:|:--:|------|
| ⭐ OpenCode Go ($10/月 (首月 $5)) | $10 | GLM-5.1/Kimi K2.6/DeepSeek V4 Pro/Qwen3.6/MiniMax M2.7 等 | / | 3.22 | 3220万 | $3.1 | N/A | 多模型聚合; 倍率 6; 支持多种 Agent harness |
| ⭐ NVIDIA NIM (免费) | 免费 | DeepSeek V4 Pro/GLM-5.1/GLM-4.7/DeepSeek V4 Flash/MiniMax M2.7 | / | N/A | 免费 🎁 | 免费 | 免费 | 不限量白嫖首选; 速度无保证; 部分模型为量化版; 免费不可持续 |
| 👍 Ollama Pro ($20/月) | $20 | GLM-4.7/MiniMax M2.7/Qwen3.5 等开源模型 | / | 11.12 | 5560万 | $1.8 | N/A | Free 版 50x; 开源模型为主; 估值为近似值 |
| 👍 Fireworks Fire Pass ($7/周) | $7/周 | Kimi K2.6 Turbo | / | N/A | N/A | N/A | N/A | Kimi K2.6 Turbo 无限 Token 调用; 周付模式灵活 |
| OpenRouter (部分模型限免) | 免费 | HY3-Preview/MiniMax M2.5/Qwen3 Coder 等 | / | N/A | 免费 🎁 | 免费 | 免费 | 中转聚合平台, 按用量计费; 部分限免模型 |
...
| 套餐 | 价格 | 模型 | TPS | 月度 Token(亿) | 每元 Token 数 | 每亿 Token 成本 | 额度倍率 | 备注 |
|------|------|------|:--:|:--:|:--:|:--:|:--:|------|
| 👍 Cursor Pro ($20/月) | $20 | 多模型 (Auto/Composer) | / | N/A | N/A | N/A | N/A | IDE 内集成 Agent; $20 API usage; 倍率 >=1 |
| 👍 Windsurf Pro ($20/月 (2周试用)) | $20 | Premium Model + SWE-1.5 无限 | / | N/A | N/A | N/A | N/A | 8-101 msg/day; SWE-1.5 不限量; Quota-based 不透明 |
| 👍 GitHub Copilot Pro ($10/月) | $10 | 多模型 | / | N/A | N/A | N/A | N/A | IDE 原生集成; 补全+Chat; 倍率 1.5 |
| 👍 CodeBuddy 个人专业版 (¥59/月) | ¥59 | 多模型 | / | N/A | N/A | N/A | N/A | 阿里出品; 限时加赠 2000 Credits; 国内 IDE 首选 |
| 👍 Trae Pro ($10/月 (7天免费)) | $10 | 多模型 | / | N/A | N/A | N/A | N/A | 字节出品; Bonus 随机赠送(有收到$130); 补全不限量 |
| Kiro Pro ($20/月 (首月免费)) | $20 | 多模型 | / | N/A | N/A | N/A | N/A | ⚠️退出付款页丢失免费资格; $0.04/credit 超量 |
| Augment Code INDIE ($20/月) | $20 | 多模型 | / | N/A | N/A | N/A | N/A | 倍率 1.25; 较新的玩家 |
| Zed Pro ($10/月) | $10 | Claude Sonnet 4.6 | / | 0.044 | 44万 | $227.3 | N/A | 编辑器原生集成; 补全不限; $5/440万Token; 倍率 0.5 |
...
|------|:--:|:--:|:--:|:--:|------|
| ⭐ DeepSeek V4 Flash (API) | ¥1/百万输入Token | - | - | - | 性价比最高按量方案; 输出 ¥2/百万; 缓存读 1/100 价格; 1M 上下文 |
| 👍 DeepSeek V4 Pro (API) | ¥3/百万输入Token | - | - | - | V4 Flash 的 3 倍价格; 推理能力更强; 1M 上下文 |
| 👍 Kimi K2.6 (API) | ¥20/百万输入Token | - | - | - | 支持多模态; 256K 上下文; 价格偏高但质量稳定 |
| 👍 GLM 5.1 (API) | ¥10/百万输入Token | - | - | - | 198K 上下文; SWE-Bench Pro SOTA; 性价比好 |
